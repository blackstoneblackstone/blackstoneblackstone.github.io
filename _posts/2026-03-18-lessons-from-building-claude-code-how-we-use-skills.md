...
![Skills 分类总览](https://pbs.twimg.com/media/HDo5BLyXEAA8McR?format=jpg&name=large)
...
![编写 Skills 的最佳实践](https://pbs.twimg.com/media/HDo5Dl9XsAAWY7o?format=jpg&name=large)
...
![踩坑点章节示例](https://pbs.twimg.com/media/HDo5GDjbEAMAlZj?format=jpg&name=large)

任何 Skill 中信息量最大的部分就是踩坑点章节。这些章节应该根据 Claude 在使用你的 Skill 时遇到的常见失败点逐步积累起来。理想情况下，你会持续更新 Skill 来记录这些踩坑点。

### 利用文件系统与渐进式披露

![文件系统与渐进式披露](https://pbs.twimg.com/media/HDo5JN1WQAAPmnG?format=jpg&name=large)
...
![灵活性示例](https://pbs.twimg.com/media/HDo5Lo1W8AArlpo?format=jpg&name=large)

### 考虑好初始设置

![初始设置示例](https://pbs.twimg.com/media/HDo5OrObEAAENZA?format=jpg&name=large)
...
![description 字段示例](https://pbs.twimg.com/media/HDo5Rspa0AApYXU?format=jpg&name=large)

### 记忆与数据存储

![记忆与数据存储示例](https://pbs.twimg.com/media/HDo5UrhbEAAqlvQ?format=jpg&name=large)
...
![脚本与辅助函数示例](https://pbs.twimg.com/media/HDo5XLwXcAA-ocz?format=jpg&name=large)

Claude 就可以即时生成脚本来组合这些功能，完成更高级的分析——比如回答"周二发生了什么？"这样的问题。

![生成代码示例](https://pbs.twimg.com/media/HDo5ZkUW0AAMmfP?format=jpg&name=large)
