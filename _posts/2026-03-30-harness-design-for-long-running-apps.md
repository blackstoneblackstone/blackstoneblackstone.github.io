...
![荷兰艺术博物馆网站设计迭代](https://images.blackstones.xyz/2026/03/harness-design/dutch-museum.png)
...
![单独 harness 创建的应用程序打开时的初始屏幕](https://images.blackstones.xyz/2026/03/harness-design/solo-harness-opening.png)
...
![使用完整 harness 构建的应用程序中的初始屏幕：创建新游戏](https://images.blackstones.xyz/2026/03/harness-design/full-harness-opening.png)
...
![DAW 截图](https://images.blackstones.xyz/2026/03/harness-design/daw-screenshot.png)
