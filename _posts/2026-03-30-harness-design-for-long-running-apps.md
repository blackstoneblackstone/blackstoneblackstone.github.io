...
categories: 文章
tags: [AI, Claude, Agent, Harness设计, 翻译]
author: 黑石
excerpt: Harness 设计是智能体编码前沿性能的关键。Anthropic 团队如何通过三智能体架构（规划器、生成器、评估器）推动 Claude 在前端设计和长时自主软件工程方面取得突破。
---
...
![荷兰艺术博物馆网站设计迭代](https://pub-8617e03a1751410f91e0725f5b544a27.r2.dev/2026/03/harness-design/dutch-museum.png)
...
![单独 harness 创建的应用程序打开时的初始屏幕](https://pub-8617e03a1751410f91e0725f5b544a27.r2.dev/2026/03/harness-design/solo-harness-opening.png)
...
![使用完整 harness 构建的应用程序中的初始屏幕：创建新游戏](https://pub-8617e03a1751410f91e0725f5b544a27.r2.dev/2026/03/harness-design/full-harness-opening.png)
...
<video src="https://cdn.sanity.io/files/4zrzovbb/website/9877febd34432f7f582aecd0023b951223605c6a.mp4" controls></video>

该应用程序远非专业的音乐制作程序，智能体的歌曲创作技能显然还有很多工作要做。此外，Claude 实际上听不到，这使得 QA 反馈循环在音乐品味方面的效果降低。

![DAW 截图](https://pub-8617e03a1751410f91e0725f5b544a27.r2.dev/2026/03/harness-design/daw-screenshot.png)
